...
import myPhoto from "@assets/Photo_1771955679545.jpg";
  ...
  return (
    ...
    src="/re.webm.crdownload"
          ...
          <motion.div
            ...
            className="absolute bottom-4 right-4 z-20 bg-background/60 backdrop-blur-xl p-3 pr-5 rounded-2xl border border-white/10 shadow-2xl flex items-center gap-4"
          >
